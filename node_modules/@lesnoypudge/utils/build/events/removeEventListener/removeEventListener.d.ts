...
type RemoveEventListener = <ProvidedElement extends ElementUnion, EventName extends keyof AvailableEventNames<ProvidedElement>>(element: ProvidedElement, eventName: EventName, fn: (e: AvailableEventNames<ProvidedElement>[EventName]) => void) => void;
